...
namespace BootstrapMvc
{
    public static class TableSectionExtensions
    {
        ...
        public static IItemWriter<TableHeader, TableSectionContent> TableHeader(this IAnyContentMarker contentHelper, TableHeaderColor color)
        {
            return contentHelper.CreateWriter<TableHeader, TableSectionContent>().Color(color);
        }
        ...
        public static TableSectionContent BeginTableHeader(this IAnyContentMarker contentHelper, TableHeaderColor color)
        {
            return TableHeader(contentHelper, color).BeginContent();
        }
