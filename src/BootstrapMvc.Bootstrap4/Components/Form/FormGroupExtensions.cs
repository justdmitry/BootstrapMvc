namespace BootstrapMvc
{
    ...
    public static class FormGroupExtensions
    {
        ...
        public static IItemWriter<T, AnyContent> WithCheckboxOrRadio<T>(this IItemWriter<T, AnyContent> target, bool value = true)
            where T : FormGroup
        {
            target.Item.WithCheckboxOrRadio = value;
            return target;
        }
